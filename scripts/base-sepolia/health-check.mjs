/**
 * Health Check Script for Base Sepolia Testnet
 *
 ...
 *   npm run base-sepolia:health-check
 */
...
async function main() {
  ...
  console.log("  Bitres Base Sepolia Health Check");
  console.log("=".repeat(70));
  ...
  const pairs = [
    { name: "PairWBTCUSDC", label: "cbBTC/USDC" },
  ...
  const priceChecks = [
    { name: "cbBTC", fn: "getBTCCollateralPrice" },
